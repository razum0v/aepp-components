...
describe('AeInput', () => {
  describe('address', () => {
    it('formats passed value', () => {
      const wrapper = mount(AeInput, { propsData: {
    ...
    it('adds prefix on input', () => {
      const wrapper = mount(AeInput, { propsData: { type: 'address' } })
    ...
    it('emitted input event contains address without space symbols', () => {
      ...
      const wrapper = mount(AeInput, { propsData: { type: 'address', value: address } })
      wrapper.trigger('input')
